...
{
    public interface IBaseDB<TEntity> where TEntity : class
    {
        ...
        Task<bool> UpdateOrDelete(string strSql, SugarParameter[] parameters = null);
        ...
        Task<dynamic> QuerySqlDynamic(string strSql, SugarParameter[] parameters = null);
